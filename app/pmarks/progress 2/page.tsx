    ...
    <div>
      <Layout>
        ...
        <div className="pt-5 pl-5">
            <div className="text-blue-700 font-extrabold text-center text-[22px]">Enter Progress-2 Presentation Marks</div>
        </div>   
         <div className=" mt-4">  
        ...
        <div className="grid grid-cols-3 gap-4">
            ...
            <div>
                        <div className=" bg-blue-50 shadow-lg rounded-lg text-blue-600 m-5 p-5 ">
                            ...
                            <div className=" m-2">
                                <label className=" mr-[99px] m-4 ">Content</label>
                                <input className=" w-[60px]" type="number" id="sid2ProConM" /> <br />
                            </div>
                                
                            <div className=" m-2">
                                <label className=" mr-[30px] m-4">Presentation Skill</label>
                                <input className=" w-[60px]" type="number" id="sid2ProPrM" /> <br />
                            </div>
                                
                            <div className=" m-2">
                                <label className=" mr-[19px]  m-4">Time Management</label>
                                <input className=" w-[60px]" type="number" id="sid2ProTmM" /> <br />
                            </div>

                            <div className=" m-2">
                                <label className=" m-4">Comment</label> <br />
                                <input className=" ml-4 mb-2 w-[220px]" type="textarea" id="sid2ProCo" /> <br />
                            </div>

                            <div className="ml-[40px] mt-3">
                                <label className=" text-gray-400 mr-[15px] ml-3">Total Mark</label>
                                <input className=" w-[60px]" type="number" id="sid2ProTM" /> <br />
                            </div>
          ...
          <div>
            ...
            <div className=" bg-blue-50 shadow-lg rounded-lg text-blue-600 mx-5 p-5 ">
                ...
                <div className=" m-2">
                     <label className=" mr-[99px] m-4 ">Content</label>
                    <input className=" w-[60px]" type="number" id="sid3ProConM" /> <br />
                </div>
                    
                <div className=" m-2">
                    <label className=" mr-[30px] m-4">Presentation Skill</label>
                    <input className=" w-[60px]" type="number" id="sid3ProPrM" /> <br />
                </div>
                    
                <div className=" m-2">
                     <label className=" mr-[19px]  m-4">Time Management</label>
                    <input className=" w-[60px]" type="number" id="sid3ProTmM" /> <br />
                </div>

                <div className=" m-2">
                     <label className=" m-4">Comment</label> <br />
                    <input className=" ml-4 mb-2 w-[220px]" type="textarea" id="sid3ProCo" /> <br />
                </div>

                <div className="ml-[40px] mt-3">
                     <label className=" text-gray-400 mr-[15px] ml-3">Total Mark</label>
                    <input className=" w-[60px]" type="number" id="sid3ProTM" /> <br />
                </div>
            ...
            <div className=" bg-blue-50 shadow-lg rounded-lg text-blue-600 mx-5 p-5 ">
                <div className="ml-[29px] mb-3">
                     <label className=" ml-3 text-blue-600 font-bold">Student ID</label>
                    <input className=" ml-2 w-[90px]" type="text" id="sid4" /> <br />
                </div>
                ...
                <div className=" m-2">
                     <label className=" mr-[99px] m-4 ">Content</label>
                    <input className=" w-[60px]" type="number" id="sid4ProConM" /> <br />
                </div>
                    
                <div className=" m-2">
                    <label className=" mr-[30px] m-4">Presentation Skill</label>
                    <input className=" w-[60px]" type="number" id="sid4ProPrM" /> <br />
                </div>
                    
                <div className=" m-2">
                     <label className=" mr-[19px]  m-4">Time Management</label>
                    <input className=" w-[60px]" type="number" id="sid4ProTmM" /> <br />
                </div>

                <div className=" m-2">
                     <label className=" m-4">Comment</label> <br />
                    <input className=" ml-4 mb-2 w-[220px]" type="textarea" id="sid4ProCo" /> <br />
                </div>

                <div className="ml-[40px] mt-3">
                     <label className=" text-gray-400 mr-[15px] ml-3">Total Mark</label>
                    <input className=" w-[60px]" type="number" id="sid4ProTM" /> <br />
                </div>
